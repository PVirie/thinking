...
class Model(abstraction_model.Model):
    ...
    def abstract_path(self, path: State_Sequence) -> Tuple[Pointer_Sequence, State_Sequence]:
        ...
        index_seq = Pointer_Sequence(maxima_indices)
        # TODO: pivot_seq should compute average of the surrounding points
        pivot_seq = State_Sequence(path.data[maxima_indices])

        return index_seq, pivot_seq
    ...
    def abstract(self, from_sequence: Augmented_State_Squence, action: Action) -> Tuple[State, Action]:
        ...
        # TODO: get the average of the surrounding points
        pivot = State(from_sequence.data[last_maxima_indice, 0, :])
